###############################################################
# Script: 23_dplyr_full_join.R
#
# Purpose:
#   Demonstrate how to merge datasets using dplyr::full_join()
#   (keeps all rows from both tables, filling missing matches with NA).
#
#   Demonstrated steps:
#     - Create two tea datasets sharing a common key (farm)
#     - Perform full_join() using default matching column names
...
# ---------------------------------------------------------------------------
# 3. Basic full_join(): keeps all rows from both tables
# ---------------------------------------------------------------------------
full_join(df_yield, df_grade, by = "farm")
...
full_join(df_yield2, df_grade, by = c("farm_id" = "farm"))
...
full_join(df_multi, df_grade_multi, by = c("farm","grade"))

# ---------------------------------------------------------------------------
# End of script — full_join() preserves all rows from both tables!
# ---------------------------------------------------------------------------
# 💡 Tip:
# Use full_join() when you want a complete union of two tables, with NA for missing matches.
###############################################################